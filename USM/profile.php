...
<body class="min-h-screen">
    ...
    <div class="flex flex-col flex-1 bg-gray-50 overflow-auto">
      ...
      <main class="p-6">
        <div class="mx-auto max-w-7xl">
          <!-- Header -->
          <div class="mb-8">
            <h6 class="mb-2 font-bold text-gray-900 text-3xl">My Profile</h6>
          ...
          <div class="gap-6 grid grid-cols-1 md:grid-cols-2 mb-8">
            ...
            <div class="bg-white hover:bg-gray-50 shadow-2xl hover:shadow-2xl p-5 rounded-xl text-black hover:scale-105 transition-all duration-300 stat-card">
              <div class="flex justify-between items-start">
                <div>
                  <p class="hover:drop-shadow-md font-medium text-[#001f54] text-sm transition-all">Total Activities</p>
                  <h3 class="mt-1 font-bold text-3xl"><?php echo $total_activities; ?></h3>
                  <p class="mt-1 text-gray-500 text-xs">All recorded activities</p>
                </div>
                <div class="flex justify-center items-center bg-[#001f54] hover:bg-[#002b70] p-3 rounded-lg transition-all duration-300">
                  <i class="text-[#F7B32B] text-2xl fas fa-chart-line"></i>
                </div>
              </div>
            </div>
            ...
            <div class="bg-white hover:bg-gray-50 shadow-2xl hover:shadow-2xl p-5 rounded-xl text-black hover:scale-105 transition-all duration-300 stat-card">
              <div class="flex justify-between items-start">
                <div>
                  <p class="hover:drop-shadow-md font-medium text-[#001f54] text-sm transition-all">Total Logins</p>
                  <h3 class="mt-1 font-bold text-3xl"><?php echo $total_logins; ?></h3>
                  <p class="mt-1 text-gray-500 text-xs">Successful logins</p>
                </div>
                <div class="flex justify-center items-center bg-[#001f54] hover:bg-[#002b70] p-3 rounded-lg transition-all duration-300">
                  <i class="text-[#F7B32B] text-2xl fas fa-sign-in-alt"></i>
                </div>
              </div>
            </div>
          ...
          <div class="gap-8 grid grid-cols-1 lg:grid-cols-4">
            ...
            <div class="lg:col-span-1">
              <div class="top-6 sticky bg-white p-6 profile-card">
                <!-- Profile Picture -->
                <div class="flex flex-col items-center mb-6">
                  <div class="relative mb-4">
                    <!-- In your profile page HTML, update the image source -->
                    <div class="bg-gradient-to-br from-gray-100 to-gray-200 rounded-full overflow-hidden profile-avatar">
                      <?php
                    ...
                    <button onclick="openUploadModal()"
                      class="right-2 bottom-2 absolute shadow-lg btn btn-sm btn-primary btn-circle">
                      <i data-lucide="camera" class="w-4 h-4"></i>
                    </button>
                  </div>

                  <h3 class="mb-1 font-bold text-gray-900 text-xl"><?php echo htmlspecialchars($user['employee_name']); ?></h3>
                  <p class="mb-2 text-gray-500"><?php echo htmlspecialchars($user['role']); ?></p>
                  <p class="text-gray-400 text-sm">Employee ID: <?php echo htmlspecialchars($user['employee_id']); ?></p>
                </div>

                <!-- Statistics -->
                <div class="space-y-3 mb-6">
                  <div class="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-100 stat-card">
                    <div class="flex justify-between items-center">
                      <div>
                        <p class="text-gray-500 text-sm">Department</p>
                        <p class="font-semibold text-gray-900 text-lg"><?php echo htmlspecialchars($user['dept_name']); ?></p>
                      </div>
                  ...
                  <div class="bg-gradient-to-r from-green-50 to-emerald-50 border border-green-100 stat-card">
                    <div class="flex justify-between items-center">
                      <div>
                ...
                <div class="flex flex-col space-y-1">
                  <button onclick="switchTab('profile')"
                    class="text-left tab-btn active" id="tab-profile">
                  ...
                  <button onclick="switchTab('password')"
                    class="text-left tab-btn" id="tab-password">
                    <div class="flex items-center gap-3">
                  ...
                  <button onclick="switchTab('activity')"
                    class="text-left tab-btn" id="tab-activity">
                    <div class="flex items-center gap-3">
                  ...
                  <button onclick="switchTab('logs')"
                    class="text-left tab-btn" id="tab-logs">
                    <div class="flex items-center gap-3">
            ...
            <div class="lg:col-span-3">
              ...
              <div id="profile-tab" class="tab-content">
                <div class="bg-white p-8 profile-card">
                  <div class="flex justify-between items-center mb-8">
                    <div>
                      <h4 class="font-bold text-gray-900 text-2xl">Profile Information</h4>
                      <p class="text-gray-500">Update your personal details and contact information</p>
                    </div>
                    <button onclick="enableEditing()"
                      class="hover:bg-gray-50 border-gray-300 btn-outline btn">
                  ...
                  <form id="profile-form" class="space-y-6">
                    <div class="gap-6 grid grid-cols-1 md:grid-cols-2">
                      <div>
                        ...
                        <input type="text"
                          ...
                          class="bg-gray-50 px-4 py-3 border border-gray-300 rounded-lg w-full text-gray-500"
                          disabled>
                      </div>

                      <div>
                        <label class="block mb-2 font-medium text-gray-700 text-sm">Employee ID</label>
                        <input type="text"
                      ...
                      <div>
                        ...
                        <input type="email"
                          ...
                          class="bg-gray-50 px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/20 w-full text-gray-500 input-field"
                          disabled>
                      </div>

                      <div>
                        <label class="block mb-2 font-medium text-gray-700 text-sm">Department</label>
                        <input type="text"
                      ...
                      <div>
                        <label class="block mb-2 font-medium text-gray-700 text-sm">Role</label>
                        <input type="text"
                      ...
                      <div>
                        <label class="block mb-2 font-medium text-gray-700 text-sm">Last Login</label>
                        <input type="text"
                          value="<?php
                                  if ($user['last_login'] !== 'Never') {
                                    try {
                    ...
                    <div id="form-actions" class="hidden flex justify-end gap-3 pt-6 border-gray-100 border-t">
                      <button type="button"
              ...
              <!-- Change Password Tab -->
              <div id="password-tab" class="hidden tab-content">
                <div class="bg-white p-8 profile-card">
                  <h4 class="mb-2 font-bold text-gray-900 text-2xl">Change Password</h4>
                  <p class="mb-8 text-gray-500">Update your password to keep your account secure</p>
                  ...
                  <form id="password-form" class="space-y-6 max-w-md">
                    <div>
                      ...
                      <div class="relative">
                        <input type="password"
                          ...
                          class="bg-white px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/20 w-full input-field"
                          required>
                        <button type="button"
                    ...
                    <div>
                      ...
                      <div class="space-y-2 mt-2">
                        <div class="flex items-center gap-2">
                          <div id="password-strength" class="bg-gray-200 w-full password-strength"></div>
                          <span id="strength-text" class="font-medium text-xs"></span>
                        </div>
                        <p class="text-gray-500 text-xs">Password must be at least 8 characters with uppercase, lowercase, number, and special character.</p>
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <p id="password-match" class="hidden mt-2 text-xs"></p>
                    </div>

                    <div class="pt-4">
                      <button type="submit"
                        class="px-8 btn btn-primary">
                        Update Password
                      </button>
                    </div>
                  </form>
              ...
              <div id="activity-tab" class="hidden tab-content">
                <div class="bg-white p-8 profile-card">
                  <div class="flex sm:flex-row flex-col justify-between items-start sm:items-center mb-6">
                    <div>
                      <h4 class="font-bold text-gray-900 text-2xl">Recent Activity</h4>
                    </div>
                    ...
                    <div class="flex flex-wrap gap-3 mt-4 sm:mt-0">
                      ...
                      <div class="relative">
                        ...
                        <input type="text"
                          ...
                          class="bg-white py-2 pr-4 pl-10 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/20"
                          value="<?php echo htmlspecialchars($activity_search); ?>">
                      </div>

                      <!-- Type Filter -->
                      <select id="activity-type-filter" class="bg-white border-gray-300 select-bordered select">
                  ...
                  <?php if (!empty($recent_activities)): ?>
                    <div class="table-container">
                      <table class="table w-full">
                        <thead>
                          <tr class="bg-gray-50">
                            <th class="px-4 py-3 font-semibold text-gray-700">Activity</th>
                            <th class="px-4 py-3 font-semibold text-gray-700">Type</th>
                            <th class="px-4 py-3 font-semibold text-gray-700">Department</th>
                        ...
                        <tbody>
                          ...
                          <?php foreach ($recent_activities as $activity): ?>
                            <tr class="hover:bg-gray-50 border-gray-100 border-b activity-item">
                              <td class="px-4 py-4">
                                <div class="flex items-center">
                                  <!-- User Profile Image -->
                                  <div class="flex-shrink-0 mr-3">
                                    <div class="bg-gray-200 border border-gray-300 rounded-full w-10 h-10 overflow-hidden">
                                      <?php
                                  ...
                                  <div class="flex-1">
                                    ...
                                    <?php if (isset($activity['employee_name'])): ?>
                                      <div class="flex items-center text-gray-500 text-sm">
                                        <i data-lucide="user" class="mr-1 w-3 h-3"></i>
                              ...
                              <td class="px-4 py-4">
                                ...
                                if (!empty($date_str)) {
                                  try {
                                    ...
                                    echo '<div class="text-gray-500 text-sm">' . $date->format('H:i:s') . '</div>';
                                  } catch (Exception $e) {
                  ...
                  <?php else: ?>
                    <div class="py-12 text-center">
                      <i data-lucide="activity" class="mx-auto mb-4 w-16 h-16 text-gray-300"></i>
                      <h5 class="mb-2 font-medium text-gray-900 text-lg">No Activity Found</h5>
              ...
              <div id="logs-tab" class="hidden tab-content">
                <div class="bg-white p-8 profile-card">
                  <div class="flex sm:flex-row flex-col justify-between items-start sm:items-center mb-6">
                    <div>
                      <h4 class="font-bold text-gray-900 text-2xl">Login History</h4>
                    </div>
                    ...
                    <div class="flex flex-wrap gap-3 mt-4 sm:mt-0">
                      ...
                      <!-- Status Filter -->
                      <select id="login-status-filter" class="bg-white border-gray-300 select-bordered select">
                      ...
                      <!-- Type Filter -->
                      <select id="login-type-filter" class="bg-white border-gray-300 select-bordered select">
                        <option value="">All Types</option>
                      ...
                      <table class="table w-full">
                        <thead>
                          <tr class="bg-gray-50">
                            ...
                            <th class="px-4 py-3 font-semibold text-gray-700">Type</th>
                            <th class="px-4 py-3 font-semibold text-gray-700">Attempts</th>
                  ...
                  <?php else: ?>
                    <div class="py-12 text-center">
                      <i data-lucide="history" class="mx-auto mb-4 w-16 h-16 text-gray-300"></i>
                      <h5 class="mb-2 font-medium text-gray-900 text-lg">No Login History</h5>
  ...
  <div id="upload-modal" class="modal">
    <div class="bg-white/90 text-black modal-box">
      <h3 class="mb-2 font-bold text-gray-900 text-xl">Update Profile Picture</h3>
      <p class="mb-6 text-gray-500">Upload a new profile picture (JPG, PNG, or GIF)</p>

      <form id="upload-form" enctype="multipart/form-data">
        <div class="mb-4 p-8 text-center upload-area"
          id="drop-area"
          ondrop="dropHandler(event)"
          ondragover="dragOverHandler(event)">
          <i data-lucide="upload" class="mx-auto mb-4 w-12 h-12 text-gray-400"></i>
          <p class="mb-2 text-gray-700">Drag & drop your image here</p>
          <p class="mb-4 text-gray-400 text-sm">or</p>
          <input type="file"
            id="file-input"
            name="image_url"
            accept="image/*"
          ...
          <label for="file-input" class="border-gray-300 btn-outline cursor-pointer btn">
            Browse Files
          </label>
          <p class="mt-4 text-gray-400 text-xs">Maximum file size: 5MB</p>
        </div>

        <!-- Image Preview -->
        <div id="image-preview" class="hidden mb-6">
          <p class="mb-2 font-medium text-gray-700 text-sm">Preview:</p>
          <div class="relative border border-gray-300 rounded-lg w-32 h-32 overflow-hidden">
  ...
  <script>
    ...
    document.getElementById('upload-form').addEventListener('submit', async function(e) {
      ...
      uploadBtn.innerHTML = '<i data-lucide="loader" class="mr-2 w-4 h-4 animate-spin"></i> Uploading...';
