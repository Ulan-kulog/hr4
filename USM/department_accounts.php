        ...
        <div class="bg-white border border-gray-100 card">
          ...
          <div class="p-8 card-body">
            <div class="flex md:flex-row flex-col justify-between items-start md:items-center gap-6 mb-8">
              <div>
                <h6 class="mb-1 font-bold text-gray-900 text-3xl">Department Accounts</h6>
            ...
            <div class="border border-gray-100 rounded-xl overflow-x-auto">
              <table class="table divide-y divide-gray-200">
                ...
                <thead>
                  <tr class="bg-gray-50">
                    <th class="px-6 py-3 font-medium text-gray-500 text-xs text-left uppercase tracking-wider">Dept ID</th>
                      ...
                      <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 text-sm whitespace-nowrap">
                          ...
                          <span class="<?php echo $statusClass; ?>">
                            <i data-lucide="<?php
                                            echo $status === 'active' ? 'check-circle' : ($status === 'inactive' ? 'x-circle' : 'clock');
                    ...
                    <tr>
                      <td colspan="5" class="py-12 text-center">
                        <div class="flex flex-col justify-center items-center gap-4">
                          ...
                          <div class="space-y-1">
                            <h3 class="font-medium text-gray-900 text-lg">No department accounts found</h3>
                            <p class="text-gray-500">Create your first department account to get started</p>
                          </div>
                          <button class="flex items-center gap-2 bg-indigo-600 hover:bg-indigo-700 shadow-sm hover:shadow-md mt-4 px-6 py-2.5 border-none rounded-lg transition-all btn btn-primary">
