  ...
  <div class="flex h-screen">
        ...
        <div class="flex-1 flex flex-col overflow-auto">
            ...
            <header class="bg-white shadow-sm border-b border-gray-200">
                <div class="flex justify-between items-center px-6 py-4">
                    <h1 class="text-2xl font-bold text-gray-800">Benefits Enrollment & Management</h1>
            ...
            <main class="flex-1 p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                    <div class="stat-card bg-white text-black shadow-2xl p-5 rounded-xl transition-all duration-300 hover:shadow-2xl hover:scale-105 hover:bg-gray-50">
                        <div class="flex justify-between items-start">
                            <div>
                                <p class="text-sm font-medium text-[#001f54]">Total Enrolled</p>
                                <h3 class="text-3xl font-bold mt-1">342</h3>
                    ...
                    <div class="stat-card bg-white text-black shadow-2xl p-5 rounded-xl transition-all duration-300 hover:shadow-2xl hover:scale-105 hover:bg-gray-50">
                        <div class="flex justify-between items-start">
                            <div>
                                <p class="text-sm font-medium text-[#001f54]">Active Plans</p>
                    ...
                    <div class="stat-card bg-white text-black shadow-2xl p-5 rounded-xl transition-all duration-300 hover:shadow-2xl hover:scale-105 hover:bg-gray-50">
                        <div class="flex justify-between items-start">
                            <div>
                                ...
                                <p class="text-xs text-gray-500 mt-1">Approvals</p>
                            </div>
                            <div class="p-3 rounded-lg bg-[#001f54] flex items-center justify-center">
                    ...
                    <div class="stat-card bg-white text-black shadow-2xl p-5 rounded-xl transition-all duration-300 hover:shadow-2xl hover:scale-105 hover:bg-gray-50">
                        <div class="flex justify-between items-start">
                            <div>
                                <p class="text-sm font-medium text-[#001f54]">Coverage Rate</p>
                                <h3 class="text-3xl font-bold mt-1">89%</h3>
                                <p class="text-xs text-gray-500 mt-1">Of workforce</p>
                            </div>
                            <div class="p-3 rounded-lg bg-[#001f54] flex items-center justify-center">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                        <h3 class="font-semibold text-gray-800 mb-4">Plan Distribution</h3>
                        <canvas id="planDistributionChart"></canvas>
                    </div>
                    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                        <h3 class="font-semibold text-gray-800 mb-4">Enrollment Status</h3>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                    <div class="flex justify-between items-center mb-6">
                        <h3 class="font-semibold text-gray-800">Employee Enrollments</h3>
                        <div class="flex gap-2">
                            <input type="text" placeholder="Search employees..." class="px-4 py-2 border border-gray-300 rounded-lg">
                            <select class="px-4 py-2 border border-gray-300 rounded-lg">
                                <option>All Plans</option>
                                <option>Basic HMO</option>
                        ...
                        <table class="w-full">
                            <thead>
                                <tr class="border-b border-gray-200">
                                    ...
                                    <th class="text-left py-3 px-4 text-sm font-medium text-gray-600">Plan Type</th>
                                    <th class="text-left py-3 px-4 text-sm font-medium text-gray-600">Dependents</th>
                                    <th class="text-left py-3 px-4 text-sm font-medium text-gray-600">Effective Date</th>
                            ...
                            <tbody>
                                <tr class="border-b border-gray-100 hover:bg-gray-50">
                                    <td class="py-3 px-4">
                                        <div class="flex items-center">
                                            <div class="w-8 h-8 bg-blue-100 rounded-full flex items-center justify-center mr-3">
                                                <span class="text-sm font-medium text-blue-600">MJ</span>
                                            </div>
                                            <div>
                                    ...
                                    <td class="py-3 px-4 text-sm text-gray-700">Premium HMO</td>
    ...
    <script>
        ...
        new Chart(planCtx, {
            type: 'doughnut',
            data: {
                labels: ['Basic HMO', 'Premium HMO', 'Family Plan', 'Senior Plan'],
                datasets: [{
                    data: [45, 30, 20, 5],
        ...
        const statusCtx = document.getElementById('enrollmentStatusChart').getContext('2d');
        new Chart(statusCtx, {
            type: 'bar',
            data: {
